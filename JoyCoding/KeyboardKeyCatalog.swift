...
enum KeyboardKeyCatalog {
    ...
    static func displayName(for keyCode: UInt16) -> String {
        let names: [Int: String] = [
            ...
            kVK_Space:"Space", kVK_Return:"Return", kVK_Tab:"Tab", kVK_Escape:"Escape", kVK_Delete:"Delete", kVK_ForwardDelete:"Forward Delete", kVK_Home:"Home", kVK_End:"End", kVK_PageUp:"Page Up", kVK_PageDown:"Page Down", kVK_Help:"Help", kVK_UpArrow:"↑", kVK_DownArrow:"↓", kVK_LeftArrow:"←", kVK_RightArrow:"→",
